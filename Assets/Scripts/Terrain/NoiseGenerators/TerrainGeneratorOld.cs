...
namespace Assets.Scripts.Terrain
{
    public class TerrainGeneratorOld : MonoBehaviour
    {
        ...
        public void GenerateTerrain()
        {
            ...
            int[,] noise = PerlinNoiseSmooth(mapArray, seed, 4);

            RenderMap(noise, tilemap, tile);
        }


        /**
         * Generates an array of integers representing our tilemap
         * 
         * int  width   The width of our map
         * int  height  The height of our map
         * bool empty   Should we populate the map with empty/full tiles
         * 
         */
        private int[,] GenerateArray(int width, int height, bool empty = true)
        {
